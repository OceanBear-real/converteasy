...
def pdf_to_images(pdf_path: str, dpi: int = 200) -> List[Image.Image]:
    ...
    try:
        ...
        print(
            "[ERROR]   - Windows: 下载 https://github.com/oschwartz10612/poppler-windows/releases/"
        )
...
def create_ppt_from_images(
    images: List[Image.Image], output_path: str, slide_width: float = 10, slide_height: float = 7.5
) -> bool:
    """
        ...
        for i, image in enumerate(images, 1):
            ...
            try:
                ...
                slide.shapes.add_picture(
                    temp_image_path, left, top, width=final_width, height=final_height
                )
...
def pdf_to_ppt(pdf_path: str, ppt_path: str, dpi: int = 200) -> bool:
    ...
    """
    try:
        print("[INFO] ========== PDF 转 PPT 开始 ==========")
        print("[INFO] 转换方案: 图像级转换（每页渲染为图片）")
...
def main():
    ...
    parser.add_argument(
        "--dpi", type=int, default=200, help="图像分辨率 DPI (默认: 200, 推荐: 150-300)"
    )
